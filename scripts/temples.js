...
const temples = [
  ...
  },
  {
  ...
  },
   {
    ...
    location: "Kangaroo Point, Australia",
    ...
    area: 59246,
    imageUrl:
    "https://churchofjesuschristtemples.org/assets/img/temples/sao-paulo-brazil-temple/sao-paulo-brazil-temple-46580.jpg"
  },
     {
...
oldTempleLink.addEventListener("click", () => {
  createTempleCard(
    temples.filter(temple => {
      // 1. Pega só a parte do ano (ex: "2005") e converte para número
      const year = parseInt(temple.dedicated.split(",")[0]);
      
      // 2. Compara se é menor que 1900
      return year < 1900;
    })
  );
});
...
homeTempleLink.addEventListener("click", () => createTempleCard(temples));
